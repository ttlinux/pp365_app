...
//		mArrowPath = new Path();
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		LogTools.e("childview", "onMeasure");
...
//		mArrowPath.setFillType(Path.FillType.WINDING);
	...
	{
		LogTools.e("childview","onDraw"+mCurrentStatus);
		switch (mCurrentStatus)
		{
			case STATUS_FINGER_ON:
				...
				mPaint.setColor(mColorFingerOn[0]);
				mPaint.setStrokeWidth(2);
				mPaint.setStyle(Style.FILL);
				canvas.drawCircle(mCenterX, mCenterY, mRadius, mPaint);
				// 绘制内圆
				mPaint.setColor(mColorFingerOn[1]);
				canvas.drawCircle(mCenterX, mCenterY, mRadius
						* mInnerCircleRadiusRate, mPaint);
				break;
			case STATUS_FINGER_UP:
				// 绘制外圆
				mPaint.setColor(mColorFingerUp[0]);
				mPaint.setStyle(Style.STROKE);
				mPaint.setStrokeWidth(2);
				mPaint.setStyle(Style.FILL);
				canvas.drawCircle(mCenterX, mCenterY, mRadius, mPaint);
				// 绘制内圆
				mPaint.setColor(mColorFingerUp[1]);
				canvas.drawCircle(mCenterX, mCenterY, mRadius
						* mInnerCircleRadiusRate, mPaint);
